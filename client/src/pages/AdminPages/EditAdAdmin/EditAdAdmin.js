...
import { EditAdCardAdmin } from "../../../components/AdminComponents/EditAdCardAdmin/EditAdCardAdmin"
import { Loader } from "../../../components/Loader/Loader";
import { AuthContext } from "../../../context/AuthContext";
import { useHttp } from "../../../hooks/http.hook";


export const EditAdAdmin = () => {
    ...
    return (
        <>
            {!loading && ad && <EditAdCardAdmin ad={ad} creator={creator} handleFavourite={handleFavourite} />}
        </>
    );
};
